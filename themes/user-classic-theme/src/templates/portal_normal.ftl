				...
				<div class="container">
					<div class="row">
						<div class="col-md-12 text-center text-center">
							<a class="mr-3 text-white" href="https://www.marca.com" rel="external">Marca</a>
							<a class="mx-3 text-white" href="https://as.com" rel="external">As</a>
							<a class="ml-3 text-white" href="https://www.mundodeportivo.com" rel="external">Mundo Deportivo</a>		
						</div>
					</div>
				</div>
			</footer>
